...
const api = {
  ...
  async baseOptions(params, method = "GET") {
    ...
    // header设置
    // -- 设置token
    const tokenValue = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIyIiwiZXhwIjoxNzQxMzEyOTI0fQ.eiZX6USsqkYxQN-GqMV6qcivWg5hC6qjcWW5dd2NfGyPgoCSrtUJQd9T5HEJczgywX3jAaEYAmz9FIn-fp275A'
